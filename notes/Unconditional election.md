---
aside of: "[[topic/Unconditional election|Unconditional election]]"
---
## Todo

- [Unconditional election verse list](https://www.dropbox.com/home/Documents/TULIP%20verse%20lists?select=2%2BUnconditional%2BElection.pdf)
- [Election by J.I. Packer](http://www.monergism.com/thethreshold/articles/onsite/packer/election.html)
...
- **ἐκλέγω** (eklegō) v. to select, to choose.
- **ἐκλεκτός** (eklektos) adj. : chosen out, preferred, selected.
- **ἐκλογή** (eklogē) n. : a picking out, selection, that which is chosen.
- **συνεκλεκτός** (suneklektos) adj. : selected together with.

<!-- -->

- **αἱρετίζω** (hairetizō) v. : to choose.
- **βούλομαι** (boulomai) v. : to will, to wish, to desire, implying careful deliberation or consideration.
- **θέλω** (thelō) v. : to will, to wish, to desire, implying the simple act of volition without regard to deliberation or consideration.

<!-- -->

- **γινώσκω** (ginōskō) v. : to know.
- **προγινώσκω** (proginōskō) v. : to foreknow.
- **πρόγνωσις** (prognōsis) n. : foreknowledge.

<!-- -->

- **προορίζω** (proorizō) v. : to predestine.

<!-- -->

- **προτίθημι** (protithēmi) v. : to purpose.
- **πρόθεσις** (prothesis) n. : purpose.
...
*Move this to [[topic/Effectual grace|Effectual grace]]?*
...
[^1]: Michael Horton, *The Christian Faith*
